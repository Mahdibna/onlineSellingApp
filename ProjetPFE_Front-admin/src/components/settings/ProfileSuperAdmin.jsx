...
const ProfileSuperAdmin = () => {
    ...
    return (
        <div className='flex-1 overflow-auto relative z-10 bg-gray-50 min-h-screen'>
            <Header title="Profil Super Admin" />
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
                        <div className="flex items-center gap-6">
                            ...
                            >
                                <img
                                    src={superAdmin?.profil ? `http://localhost:8080${superAdmin.profil}` : "/default-profile.jpg"}
                                    alt="Profile"
                        ...
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            onClick={() => navigate(`/edit-profile-superadmin/${superAdmin.id}`)}
